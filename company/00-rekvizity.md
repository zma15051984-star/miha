# PT IMPRESS YOURSELF CORP — реквизиты

Источники: карточка NPWP (`docs/npwp-pt.jpg`), фрагмент акта с решением
акционеров вне собрания, сиркуляр (`docs/akta-sirkuler-alamat-fragment.jpg`).
Оба прислал Михаил 26.09.2026.

| Поле | Значение | Источник |
|---|---|---|
| Название | PT. IMPRESS YOURSELF CORP | NPWP |
| Форма | PT PMA | со слов Михаила |
| NPWP (15) | 62.704.133.8-905.000 | NPWP |
...
- **Адрес на NPWP (Kuta, Badung) ≠ юр. адрес по акту (Ubud, Gianyar).**
...
- `hr/PKWTT-Oka-Sihotang-DRAFT.docx` — проект трудового договора PM.
- `hr/voprosy-sotrudniku.md` — что запросить у сотрудника.
